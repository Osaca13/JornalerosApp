...
{
    public class PersonaDbServices: DbServices<Persona>  
    {   
        public PersonaDbServices(ApplicationDbContext context):base(context)
        {
            
                   
        }

        //public async Task<IReadOnlyList<Persona>> AllItems()
        //{
