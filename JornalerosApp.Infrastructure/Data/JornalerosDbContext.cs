...
{
    public partial class JornalerosDbContext : DbContext
    {
        public JornalerosDbContext()
        {
        }

        public JornalerosDbContext(DbContextOptions<JornalerosDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("JornalerosConnection");
            }
        }
